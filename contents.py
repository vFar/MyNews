...
def loadArticles(article1):
  ...
  saveBtn1 = Button(root, text="💾", bg="#2671eb", fg='black', font=('MS Sans Serif', 16,), foreground='white', width=20, height=1, command=lambda: saveArticle(homeart[article1]['title'], homeart[article1]['description'], homeart[article1]['url']))
