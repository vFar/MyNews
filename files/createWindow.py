...
def myNews():
    global root, content, article1, categories, dropdown
    savedArr=[]
    ...
    FilterBtn = Button(navbar2, cursor="hand2", text="⚙️", bg="#eee", font=('MS Sans Serif', 14), padx=20, activeforeground="#123670", activebackground="#dedfe0", command=lambda: filterArticles(dropdownIndex))
    ...
    def openSavedList():
        ...
        for index, obj in enumerate(savedArr):
            ...
            deleteBtn=Button(box, text="🗑️", bg="red", fg="black", width=3, height=3, command=lambda: deleteArticle(savedArr[index][2]))
